...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = 'Cavavin_674e6dd69ba8570b4008_20230106143427_archive.zip';
        const ARCHIVE_SIZE       = '78878093';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '674e6dd-06143427';
        const SECONDARY_PACKAGE_HASH = '932eeba-06143427';
        const VERSION            = '1.5.1';
